 ...
 */
final class Version20240407132631 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reply_comment (id INT NOT NULL, comment_id INT DEFAULT NULL, content TEXT NOT NULL, PRIMARY KEY(id))');
